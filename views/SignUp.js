      ...
      <View style={styles.container}>
        ...
        >
            ...
            <View style={styles.textPrivate}>
                <Text style={styles.color_textPrivate}>Ao se registrar você concorda com os</Text>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}Termos de Serviço</Text>
                <Text style={styles.color_textPrivate}>{" "}e</Text>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}Politica de Privacidade</Text>
            </View>
